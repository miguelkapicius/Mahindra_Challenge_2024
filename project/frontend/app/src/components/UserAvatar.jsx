...
export default function UserAvatar({ user, src }) {
    ...
    return (
        <div className="flex flex-col items-center relative">
            ...
            {showOptions && (
                <div className="bg-secoundary p-2 flex flex-col gap-1 absolute top-full right-0 mt-2 rounded-lg duration-300">
                    <button
                        className="hover:bg-primary/5 rounded-lg px-4 py-2 flex items-center gap-2"
